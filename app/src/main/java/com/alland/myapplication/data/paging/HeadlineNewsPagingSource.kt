...
class HeadlineNewsPagingSource(private val apiService: NewsApiService, private val countryParam: String) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, ArticlesItem> {
        return try {
            ...
            val responseData = apiService.getHeadLineNews(countryParam, position, params.loadSize)
